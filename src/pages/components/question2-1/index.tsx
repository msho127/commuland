        ...
        <main>
          <div className={styles.mainWrap}>{/* 問題文 */}
            ...
            <div className={styles.choiceWrap} onClick={handleChoiceWrapClick}>{/* 選択 */}
              ...
              <ul>
                <li className={`${styles.clickBox} ${isActive1 ? styles.clickBox2 : ''} ${styles.CorrectAnswer}`} onClick={handleClick1}>{/*ここを押したときに*/}
                  <div className={styles.choiceFlex}>
                    ...
                    <svg width="14" height="19" viewBox="0 0 14 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M13.2373 8.53936C13.7859 8.93873 13.7859 9.75692 13.2373 10.1563L2.43644 18.0189C1.77552 18.5001 0.847901 18.028 0.847901 17.2105L0.8479 1.48519C0.8479 0.667692 1.77552 0.195593 2.43644 0.676718L13.2373 8.53936Z" fill="#38DD1D"/>
                    </svg>
                  </div>
                  {isActive1 && (
                  <div>{/*divの中が消える*/}
                    <div className={styles.CorrectAnswerColor}>
